...
(Official Benchmark Toolkit for Vietnamese Question and Answer Generation)
This repository provides the official training code, evaluation scripts, benchmark protocol, and run_all.sh for Vietnamese Question & Answer Generation (QAG) on the UIT-ViQuAD 2.0 dataset.
It supports 6 popular Seq2Seq models and 4 training paradigms, enabling fair comparison and reproducible research.
1. Features
...
Automatic job skipping (based on results/metrics.jsonl)
NaN checkpoint handling + automatic fp16 → bf16 fallback
Full argparse support + Hugging Face integration
One-command full benchmark via run_all.sh
...
Bashgit clone https://github.com/yourusername/Generate-Question-and-Answer-Vietnamese-Model.git
cd Generate-Question-and-Answer-Vietnamese-Model
pip install -r requirements.txt
4. How to Run
Single experiment (example)
Bash# Recommended: Instruction tuning with mt5-base
...
Bash# Just one command — automatically skips completed jobs
bash run_all.sh
...
QA format OK (for end2end & instruction methods)
...
bibtex@misc{generateqa_vietnamese2025,
